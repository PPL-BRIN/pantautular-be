...
from .views import (
    AllCaseLocationsView, CasesSummaryFilterStatsView, FiltersView, DiseaseSeverityStatsView,
...
urlpatterns = [
    ...
    path('api/severity-stats/filter/', CasesSummaryFilterStatsView.as_view(), name='dashboard-stats')
]
